                        ...
                        return (
                            <div className='card boxsh' key={item.id}>
                                ...
                                <Link to={`/${item.id}`}>
                                    ...
                                    >
                                        <SwiperSlide>
                                            <img alt="" src={item.homeMainPic} className="cardImg" />
                                        </SwiperSlide>

                                        <SwiperSlide>
                                            <img alt="" src={item.carouselPic1} className="cardImg" />
                                        </SwiperSlide>

                                        <SwiperSlide>
                                            <img alt="" src={item.carouselPic2} className="cardImg" />
                                        </SwiperSlide>

                                        <SwiperSlide>
                                            <img alt="" src={item.carouselPic3} className="cardImg" />
                                        </SwiperSlide>

                                        <SwiperSlide>
                                            <img alt="" src={item.carouselPic4} className="cardImg" />
                                        </SwiperSlide>

                                        <SwiperSlide>
                                            <img alt="" src={item.carouselPic5} className="cardImg" />
                                        </SwiperSlide>
