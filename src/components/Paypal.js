    ...
    return (
        <div className='pa'>
            ...
            <div className='paypalbghold hidden lg:block'>
                <img src={paypalbg} className="paypalbg" alt="" />
            </div>

            <div className='paypalCardHold'>
                <img src={paypalCard} className="paypalcard" alt=""  />
            ...
            <div className='paypalLogo2'>
                <img src='https://s3-us-west-2.amazonaws.com/s.cdpn.io/553128/PayPal.svg' alt=""  />
            </div>
