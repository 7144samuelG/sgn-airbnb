                          ...
                          <div className='absolute z-50 tabContentPlaces'>
                            {inputValue === "" ? <> <div className='tabContent1Hold cursor-pointer'>
                              <Link to={`/location/usa`}>
                                <img alt="" src='https://a0.muscache.com/pictures/f9ec8a23-ed44-420b-83e5-10ff1f071a13.jpg' className='tabContent1Image' />
                              </Link>
                              <Link to={`/location/europe`}>
                                <img alt="" src='https://a0.muscache.com/im/pictures/7b5cf816-6c16-49f8-99e5-cbc4adfd97e2.jpg?im_w=320' className='tabContent1Image' />
                              </Link>

                              <Link to={`/location/london`}>
                                <img alt="" src='https://a0.muscache.com/im/pictures/dbb2b5ef-2efe-4099-81ac-c7b957f384ed.jpg?im_w=320' className='tabContent1Image' />
                              </Link>
                              ...
                              <div className='secImages'>
                                <Link to={`/location/canada`}>
                                  <img alt="" src='https://a0.muscache.com/im/pictures/d77de9f5-5318-4571-88c7-e97d2355d20a.jpg?im_w=320' className='tabContent1Image' />
                                </Link>
                                <Link to={`/location/italy`}>
                                  <img alt="" src='https://a0.muscache.com/im/pictures/ebc5a343-8b76-4ae5-8700-eb5e9cec9243.jpg?im_w=320' className='tabContent1Image mr-1' />
                                </Link>
                                <Link to={`/location/kyiv`}>
                                  <img alt="" src='https://a0.muscache.com/im/pictures/66355b01-4695-4db9-b292-c149c46fb1ca.jpg?im_w=320' className='tabContent1Image' />
                                </Link>
                              </div>
          ...
          <div className="flex justify-end items-center relative">
            ...
            <div className="inline relative">
                 ...
                 className="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                  ...
                  {user ? <p  className="text-center text-xl text-bold ml-5" onClick={logoutUser}>
                  {user?.email?.substring(0, 1)}</p> :
                   <div className="block flex-grow-0 flex-shrink-0 h-10 w-12 pl-5" onClick={loginUser}>
                    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" 
                    aria-hidden="true" role="presentation" focusable="false" style={{ display: 'block',
                     height: '100%', width: '100%', fill: 'currentcolor' }}>
