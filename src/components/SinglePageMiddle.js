...
const SinglePageMiddle = () => {
    ...
    return (<div>
        ...
        <div className='section1-hold'>
            <img alt="" src='https://a0.muscache.com/im/pictures/54e427bb-9cb7-4a81-94cf-78f19156faad.jpg' className='w-36' />
        ...
        <div className='section3'>
            <img alt="" src={section3} className="c" />
        </div>
        ...
        <div className='star-calc-hold'>
            ...
            <img alt="" src={rev1} className="spm-pic" />
            <img alt="" src={rev2} className="spm-pic" />

        </div>

        <div className='review-hold'>

            <img alt="" src={reviews} className="spm-review" />
        ...
        <div className='agg'>
            ...
            <label htmlFor="my-modal-5" className="modal cursor-pointer">
                <label className="modal-box relative" for="">
                    ...
                    <img alt="" src={modalPic} className="modal-pic" />
