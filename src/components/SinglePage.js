...
const SinglePage = () => {
    ...
    return (
        ...
        <div>
            ...
            {activeImg === true ? <img src={defaltImage} alt="" className="single-page-main-pic cursor-pointer" /> : <img src={carouselPic1} className="single-page-main-pic cursor-pointer" alt="" />}


            <div className='absolute flex single-page-hold'>
                <img src={carouselPic2} alt="" className="w-40 rounded-xl cursor-pointer single-page-pic" onMouseOver={getImageSrcHnadler} onMouseLeave={setDefaultImgHnadler} />
                <img src={carouselPic3} alt="" className="w-40 rounded-xl cursor-pointer single-page-pic" onMouseOver={getImageSrcHnadler} onMouseLeave={setDefaultImgHnadler} />
                <img src={carouselPic4} alt="" className="w-40 rounded-xl cursor-pointer single-page-pic" onMouseOver={getImageSrcHnadler} onMouseLeave={setDefaultImgHnadler} />
                <img src={carouselPic5} alt=""  className="w-40 rounded-xl cursor-pointer single-page-pic" onMouseOver={getImageSrcHnadler} onMouseLeave={setDefaultImgHnadler} />
            </div>
